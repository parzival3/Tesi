...
\lstinputlisting[language=Json, firstline=1,
lastline=23]{Code_Files/global_json.conf}
\lstinputlisting[language=Json, firstline=173,
lastline=184]{Code_Files/global_json.conf}
...
La libreria utilizzate dal programma sono 
